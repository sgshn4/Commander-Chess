...
public class HeroEngineer extends Figure {
    @Override
    ...
    private static class HeroEngineerFabric extends AbstractFabricInterface {

        public HeroEngineerFabric(boolean isRed, String symbol) {
            super(isRed, symbol);
        }

        @Override
        public Figure createFigure(Point p) {
            return new HeroEngineer(p, isRed());
        }
    }


    public static final FabricInterface FACTORY_BLUE = new HeroEngineerFabric(false, "HE");
    public static final FabricInterface FACTORY_RED = new HeroEngineerFabric(true, "he");

    public HeroEngineer(Point point, boolean isRed) {
        super(point, isRed);
    }
