...
public class HeroMilitiaman extends Figure {
    @Override
    ...
    private static class HeroMilitiamanFabric extends AbstractFabricInterface {

        public HeroMilitiamanFabric(boolean isRed, String symbol) {
            super(isRed, symbol);
        }

        @Override
        public Figure createFigure(Point p) {
            return new HeroMilitiaman(p, isRed());
        }
    }


    public static final FabricInterface FACTORY_BLUE = new HeroMilitiamanFabric(false, "HM");
    public static final FabricInterface FACTORY_RED = new HeroMilitiamanFabric(true, "hm");

    public HeroMilitiaman(Point point, boolean isRed) {
        super(point, isRed);
    }
