...
public class HeroAirDefense extends Figure{
    @Override
    ...
    private static class HeroAirDefenseFabric extends AbstractFabricInterface {

        public HeroAirDefenseFabric(boolean isRed, String symbol) {
            super(isRed, symbol);
        }

        @Override
        public Figure createFigure(Point p) {
            return new HeroAirDefense(p, isRed());
        }
    }


    public static final FabricInterface FACTORY_BLUE = new HeroAirDefenseFabric(false, "HAD");
    public static final FabricInterface FACTORY_RED = new HeroAirDefenseFabric(true, "had");

    public HeroAirDefense(Point point, boolean isRed) {
        super(point, isRed);
    }
